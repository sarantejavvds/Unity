...
// This is the Example Script to Spawn an Object just once on Game Scene when Game is Started.
// Give this Script to an Empty Game Object.

public class To_Make_an_Object_Spawn_at_Game_Start : MonoBehaviour
{
    ...
    void Start()
    {
        SpawnObject();  // Make the ball spawn whenever game is started.
    }
